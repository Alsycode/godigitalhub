...
import thumbone from "public/images/agency/one.jpg";
import thumbtwo from "public/images/agency/two.jpg";
          ...
          <div className="col-12 col-lg-6">
            <div className="agency__content section__content">
              ...
              <h2 className="title title-anim">
               We are Digital Marketing Agency in Kochi
              </h2>
              <div className="paragraph">
                <p>
                Welcome to Go DigitalHub, your premier destination for cutting-edge digital marketing solutions. We're passionate about helping businesses like yours succeed in the dynamic online landscape.

At Go DigitalHub, we pride ourselves on our ability to craft tailored strategies that drive tangible results. Whether you're aiming to boost your online visibility, engage your target audience on social media, or generate more leads, our dedicated team is here to make it happen.
                </p>
              </div>
