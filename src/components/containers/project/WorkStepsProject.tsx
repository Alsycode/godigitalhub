...
import Wireframe from "public/images/wirframe.jpg"
import Discovery from "public/images/strategy.jpg"
            ...
            <div className="col-12 col-sm-6 col-xl-3">
              ...
              >
                ...
                <div
                  className="work-thumb-hover d-none d-md-block"
                  style={{
                    backgroundImage: "url('/images/wirframe.jpg')",
                  }}
                ></div>
              </div>
            </div>
            ...
            <div className="col-12 col-sm-6 col-xl-3">
              ...
              >
                ...
                <div
                  className="work-thumb-hover d-none d-md-block"
                  style={{
                    backgroundImage:  "url('/images/webd.jpg')",
                  }}
                ></div>
              </div>
            </div>
