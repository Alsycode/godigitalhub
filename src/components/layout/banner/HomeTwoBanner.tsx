            ...
            <div className="banner-two-inner">
              ...
              <div className="banner-two__content">
                <h1 className="title-anim">
                  THE <span>DIGITAL MARKETING</span> AGENCY FOR BETTER METRICS
                </h1>
                <div className="banner-two__content-cta section__content-cta">
                  <div className="paragraph">
                    <p>
                      We are a data-driven DIGITAL MARKETING agency delivering
                      complete end-to-end web, mobile experience
